...
### 🇳🇱 Nederlands
**Digitaal Contact**
Contact met de overheid gaat vaak digitaal via een computer of app. Je hebt hiervoor een **DigiD** nodig. Dit is een persoonlijk account waarmee je veilig kunt inloggen op websites van de overheid. Jouw DigiD is strikt persoonlijk; deel deze nooit met anderen. Als je hulp nodig hebt bij digitale zaken, kun je terecht bij een **Informatiepunt Digitale Overheid (IDO)** in de bibliotheek.
...
### 🇳🇱 Nederlands
**Identificatie**
Vanaf 14 jaar is iedereen in Nederland verplicht een **identiteitsbewijs** te hebben. Dit kan een **paspoort**, **identiteitskaart (ID-kaart)** of **rijbewijs** zijn. Deze documenten zijn meestal tien jaar geldig. Je vraagt ze aan bij de gemeente waar je woont.

**Belangrijke Gebeurtenissen**
*   **Verhuizen**: Als je verhuist, moet je dit binnen vijf dagen doorgeven aan je nieuwe gemeente. Je hoeft je niet uit te schrijven bij je oude gemeente.
*   **Geboorte**: Een baby moet binnen drie dagen na de geboorte worden aangegeven bij de gemeente. Als de ouders niet getrouwd zijn, kan de vader het kind **erkennen** om juridisch de ouder te worden.
*   **Trouwen en Partnerschap**: Je moet je plannen minimaal twee weken van tevoren melden bij de gemeente. Je kunt kiezen voor een gratis, eenvoudig of uitgebreid huwelijk. Er zijn altijd minimaal twee **getuigen** nodig.
*   **Overlijden**: Bij een overlijden moet er binnen zes dagen aangifte worden gedaan, meestal door de **begrafenisondernemer**.
...
**Important Events**
*   **Moving**: If you move, you must report this within five days to your new municipality. You do not need to de-register from your old municipality.
*   **Birth**: A baby must be registered with the municipality within three days of birth. If the parents are not married, the father can **acknowledge** the child to legally become the parent.
*   **Marriage and Partnership**: You must report your plans to the municipality at least two weeks in advance. You can choose a free, simple, or extensive marriage. At least two **witnesses** are always required.
*   **Death**: In the event of a death, a report must be made within six days, usually by the **funeral director**.
...
## Verblijf en Naturalisatie (Stay and Naturalization)

### 🇳🇱 Nederlands
**Verblijfsvergunning**
De **Immigratie- en Naturalisatiedienst (IND)** gaat over wie in Nederland mag wonen. Afhankelijk van je situatie (familie, werk, studie of asiel) heb je een **verblijfsvergunning** nodig. Soms moet je eerst een **mvv (machtiging tot voorlopig verblijf)** aanvragen in je eigen land en daarvoor het **basisexamen inburgering** doen.

**Nederlander Worden**
Als je Nederlander wilt worden via **naturalisatie**, moet je aan voorwaarden voldoen (zoals 5 jaar in Nederland wonen en ingeburgerd zijn). Het proces:
1.  Doe de aanvraag bij de gemeente.
2.  De IND beoordeelt de aanvraag (dit kan 12 maanden duren; de **beslistermijn**).
3.  Als de aanvraag is goedgekeurd, zet de koning zijn handtekening.
4.  Je gaat naar de **naturalisatieceremonie** en legt de **verklaring van verbondenheid** af.
...
If you want to become Dutch through **naturalization**, you must meet conditions (such as living in the Netherlands for 5 years and being integrated). The process:
1.  Apply at the municipality.
2.  The IND evaluates the application (this can take 12 months; the **decision period**).
...
## Verzekeringen en Toeslagen (Insurance and Allowances)

### 🇳🇱 Nederlands
**Verzekeringen**
Een **zorgverzekering** is verplicht voor iedereen van 18 jaar en ouder. De **basisverzekering** vergoedt de belangrijkste zorg, zoals de huisarts. Je betaalt elke maand een **premie** en hebt een **eigen risico** (het eerste deel van de kosten dat je zelf betaalt). Andere verplichte verzekeringen zijn de **autoverzekering** (voor auto-eigenaren) en soms de **opstalverzekering** (voor huiseigenaren). Handige extra verzekeringen zijn de **inboedelverzekering** (voor spullen in huis) en de **aansprakelijkheidsverzekering** (als je per ongeluk schade bij een ander veroorzaakt).

**Toeslagen**
Mensen met een laag inkomen kunnen een **toeslag** krijgen van de **Dienst Toeslagen** om de kosten te betalen. Voorbeelden zijn:
*   **Zorgtoeslag**: Voor de zorgverzekering.
*   **Huurtoeslag**: Voor de huur van je woning.
*   **Kinderopvangtoeslag**: Voor de kosten van de opvang.
*   **Kindgebonden budget**: Een extra bijdrage voor kinderen tot 18 jaar.
...
**Allowances**
People with a low income can receive an **allowance (toeslag)** from the **Benefits Service** to help pay the costs. Examples include:
*   **Healthcare allowance**: For health insurance.
*   **Rent allowance**: For the rent of your home.
...
## Politie en Recht (Police and Law)

### 🇳🇱 Nederlands
**De Politie**
De politie zorgt voor veiligheid. Er is de nationale politie en de regionale politie. De **wijkagent** is het aanspreekpunt in jouw buurt. Bij een **spoedgeval** (gevaar, gewonden, inbraak nu) bel je **112**. Bij geen spoed bel je **0900-8844**. Je kunt **aangifte doen** bij een **misdrijf**, zoals diefstal.
